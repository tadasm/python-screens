...
Use 1-2 of these after the coding portion. Pick based on how the candidate did — if they finished cleanly, lean toward #3 or #4. If they struggled but showed good instincts, #2 works well because it doesn't penalise slow coding.
...
#### 2. "An analyst reports that revenue numbers look wrong for last Tuesday. Walk me through how you'd debug this in production."
...
#### 4. "This works for 6 events. What breaks at 100M events per day?"
